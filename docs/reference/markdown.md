...
NetPoint supports markdown rendering for certain text fields.
...
```
Here's the NetPoint logo (hover to see the title text):

Inline-style: 
![alt text](/media/misc/netpoint_logo.png "Logo Title Text 1")

Reference-style: 
![alt text][logo]

[logo]: /media/misc/netpoint_logo.png "Logo Title Text 2"
```
