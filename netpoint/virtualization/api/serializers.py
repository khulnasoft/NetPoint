...
class ClusterTypeSerializer(NetPointModelSerializer):
...
class ClusterGroupSerializer(NetPointModelSerializer):
...
class ClusterSerializer(NetPointModelSerializer):
...
class VirtualMachineSerializer(NetPointModelSerializer):
...
class VMInterfaceSerializer(NetPointModelSerializer):
...
class VirtualDiskSerializer(NetPointModelSerializer):
