...
class ClusterTypeViewSet(NetPointModelViewSet):
...
class ClusterGroupViewSet(NetPointModelViewSet):
...
class ClusterViewSet(NetPointModelViewSet):
...
class VirtualMachineViewSet(ConfigContextQuerySetMixin, RenderConfigMixin, NetPointModelViewSet):
...
class VMInterfaceViewSet(NetPointModelViewSet):
...
class VirtualDiskViewSet(NetPointModelViewSet):
