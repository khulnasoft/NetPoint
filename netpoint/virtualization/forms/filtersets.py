...
class ClusterTypeFilterForm(NetPointModelFilterSetForm):
    model = ClusterType
    tag = TagFilterField(model)


class ClusterGroupFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = ClusterGroup
    tag = TagFilterField(model)
    fieldsets = (
...
class ClusterFilterForm(TenancyFilterForm, ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Cluster
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class VMInterfaceFilterForm(NetPointModelFilterSetForm):
    model = VMInterface
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class VirtualDiskFilterForm(NetPointModelFilterSetForm):
    model = VirtualDisk
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
