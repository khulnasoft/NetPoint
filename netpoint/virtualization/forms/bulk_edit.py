...
class ClusterTypeBulkEditForm(NetPointModelBulkEditForm):
...
class ClusterGroupBulkEditForm(NetPointModelBulkEditForm):
    description = forms.CharField(
        label=_('Description'),
        max_length=200,
        required=False
...
class ClusterBulkEditForm(NetPointModelBulkEditForm):
...
class VirtualMachineBulkEditForm(NetPointModelBulkEditForm):
    status = forms.ChoiceField(
        label=_('Status'),
...
class VMInterfaceBulkEditForm(NetPointModelBulkEditForm):
...
class VirtualDiskBulkEditForm(NetPointModelBulkEditForm):
    virtual_machine = forms.ModelChoiceField(
        label=_('Virtual machine'),
        queryset=VirtualMachine.objects.all(),
        required=False,
