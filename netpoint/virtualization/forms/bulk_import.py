...
class ClusterTypeImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class ClusterGroupImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class ClusterImportForm(NetPointModelImportForm):
...
class VirtualMachineImportForm(NetPointModelImportForm):
    status = CSVChoiceField(
        label=_('Status'),
...
class VMInterfaceImportForm(NetPointModelImportForm):
...
class VirtualDiskImportForm(NetPointModelImportForm):
    virtual_machine = CSVModelChoiceField(
        label=_('Virtual machine'),
        queryset=VirtualMachine.objects.all(),
        to_field_name='name'
