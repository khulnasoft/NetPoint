...
from netpoint.filtersets import OrganizationalModelFilterSet, NetPointModelFilterSet
...
class ClusterFilterSet(NetPointModelFilterSet, TenancyFilterSet, ContactModelFilterSet):
...
class VMInterfaceFilterSet(NetPointModelFilterSet, CommonInterfaceFilterSet):
    cluster_id = django_filters.ModelMultipleChoiceFilter(
...
class VirtualDiskFilterSet(NetPointModelFilterSet):
    virtual_machine_id = django_filters.ModelMultipleChoiceFilter(
        field_name='virtual_machine',
        queryset=VirtualMachine.objects.all(),
        label=_('Virtual machine (ID)'),
