...
class ClusterTypeTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ClusterGroupTable(ContactsColumnMixin, NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ClusterTable(TenancyColumnsMixin, ContactsColumnMixin, NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
