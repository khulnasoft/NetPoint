...
from netpoint.authentication import get_auth_backend_display, get_saml_idps
...
class LoginView(View):
    ...
    def get(self, request):
        ...
        if request.user.is_authenticated:
            logger = logging.getLogger('netpoint.auth.login')
...
class LogoutView(View):
    ...
    def get(self, request):
        logger = logging.getLogger('netpoint.auth.logout')
...
class ChangePasswordView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        if getattr(request.user, 'ldap_username', None):
            messages.warning(request, "LDAP-authenticated user credentials cannot be changed within NetPoint.")
