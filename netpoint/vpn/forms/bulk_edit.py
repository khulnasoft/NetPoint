...
class TunnelGroupBulkEditForm(NetPointModelBulkEditForm):
...
class TunnelBulkEditForm(NetPointModelBulkEditForm):
...
class TunnelTerminationBulkEditForm(NetPointModelBulkEditForm):
...
class IKEProposalBulkEditForm(NetPointModelBulkEditForm):
...
class IKEPolicyBulkEditForm(NetPointModelBulkEditForm):
...
class IPSecProposalBulkEditForm(NetPointModelBulkEditForm):
    encryption_algorithm = forms.ChoiceField(
        label=_('Encryption algorithm'),
        choices=add_blank_choice(EncryptionAlgorithmChoices),
        required=False
...
class IPSecPolicyBulkEditForm(NetPointModelBulkEditForm):
...
class IPSecProfileBulkEditForm(NetPointModelBulkEditForm):
    mode = forms.ChoiceField(
        label=_('Mode'),
...
class L2VPNBulkEditForm(NetPointModelBulkEditForm):
...
class L2VPNTerminationBulkEditForm(NetPointModelBulkEditForm):
    model = L2VPN
