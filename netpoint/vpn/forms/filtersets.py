...
class TunnelGroupFilterForm(NetPointModelFilterSetForm):
    model = TunnelGroup
    tag = TagFilterField(model)


class TunnelFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = Tunnel
    fieldsets = (
...
class TunnelTerminationFilterForm(NetPointModelFilterSetForm):
...
class IKEProposalFilterForm(NetPointModelFilterSetForm):
    model = IKEProposal
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IKEPolicyFilterForm(NetPointModelFilterSetForm):
    model = IKEPolicy
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IPSecProposalFilterForm(NetPointModelFilterSetForm):
    model = IPSecProposal
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IPSecPolicyFilterForm(NetPointModelFilterSetForm):
    model = IPSecPolicy
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IPSecProfileFilterForm(NetPointModelFilterSetForm):
    model = IPSecProfile
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class L2VPNFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = L2VPN
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class L2VPNTerminationFilterForm(NetPointModelFilterSetForm):
