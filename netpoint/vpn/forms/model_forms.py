...
class TunnelGroupForm(NetPointModelForm):
    slug = SlugField()
...
class TunnelForm(TenancyForm, NetPointModelForm):
...
class TunnelTerminationForm(NetPointModelForm):
...
class IKEProposalForm(NetPointModelForm):
...
class IKEPolicyForm(NetPointModelForm):
...
class IPSecProposalForm(NetPointModelForm):
...
class IPSecPolicyForm(NetPointModelForm):
    proposals = DynamicModelMultipleChoiceField(
...
class IPSecProfileForm(NetPointModelForm):
...
class L2VPNForm(TenancyForm, NetPointModelForm):
    slug = SlugField()
...
class L2VPNTerminationForm(NetPointModelForm):
