...
class TunnelGroupImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class TunnelImportForm(NetPointModelImportForm):
...
class TunnelTerminationImportForm(NetPointModelImportForm):
...
class IKEProposalImportForm(NetPointModelImportForm):
...
class IKEPolicyImportForm(NetPointModelImportForm):
...
class IPSecProposalImportForm(NetPointModelImportForm):
    encryption_algorithm = CSVChoiceField(
        label=_('Encryption algorithm'),
        choices=EncryptionAlgorithmChoices,
        required=False
...
class IPSecPolicyImportForm(NetPointModelImportForm):
...
class IPSecProfileImportForm(NetPointModelImportForm):
    mode = CSVChoiceField(
        label=_('Mode'),
...
class L2VPNImportForm(NetPointModelImportForm):
    tenant = CSVModelChoiceField(
        label=_('Tenant'),
        queryset=Tenant.objects.all(),
        required=False,
...
class L2VPNTerminationImportForm(NetPointModelImportForm):
