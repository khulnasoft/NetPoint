...
class TunnelGroupSerializer(NetPointModelSerializer):
...
class TunnelSerializer(NetPointModelSerializer):
...
class TunnelTerminationSerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class IKEProposalSerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class IKEPolicySerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class IPSecProposalSerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class IPSecPolicySerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class IPSecProfileSerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
...
class L2VPNSerializer(NetPointModelSerializer):
...
class L2VPNTerminationSerializer(NetPointModelSerializer):
