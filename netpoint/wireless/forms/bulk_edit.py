...
class WirelessLANGroupBulkEditForm(NetPointModelBulkEditForm):
...
class WirelessLANBulkEditForm(NetPointModelBulkEditForm):
...
class WirelessLinkBulkEditForm(NetPointModelBulkEditForm):
    ssid = forms.CharField(
        max_length=SSID_MAX_LENGTH,
        required=False,
        label=_('SSID')
