...
class WirelessLANGroupImportForm(NetPointModelImportForm):
...
class WirelessLANImportForm(NetPointModelImportForm):
...
class WirelessLinkImportForm(NetPointModelImportForm):
    status = CSVChoiceField(
        label=_('Status'),
