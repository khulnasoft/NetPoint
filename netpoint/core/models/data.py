...
from netpoint.constants import CENSOR_TOKEN, CENSOR_TOKEN_CHANGED
from netpoint.models import PrimaryModel
from netpoint.models.features import JobsMixin
...
logger = logging.getLogger('netpoint.core.data')
