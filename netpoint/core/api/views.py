...
from netpoint.api.viewsets import NetPointModelViewSet, NetPointReadOnlyModelViewSet
...
class DataSourceViewSet(NetPointModelViewSet):
...
class DataFileViewSet(NetPointReadOnlyModelViewSet):
