...
from netpoint.api.serializers import BaseModelSerializer, NetPointModelSerializer
from netpoint.utils import get_data_backend_choices
...
class DataSourceSerializer(NetPointModelSerializer):
...
class DataFileSerializer(NetPointModelSerializer):
    url = serializers.HyperlinkedIdentityField(
