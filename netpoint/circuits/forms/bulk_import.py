...
class ProviderImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class ProviderAccountImportForm(NetPointModelImportForm):
...
class ProviderNetworkImportForm(NetPointModelImportForm):
    provider = CSVModelChoiceField(
        label=_('Provider'),
        queryset=Provider.objects.all(),
        to_field_name='name',
...
class CircuitTypeImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class CircuitImportForm(NetPointModelImportForm):
    provider = CSVModelChoiceField(
        label=_('Provider'),
        queryset=Provider.objects.all(),
        to_field_name='name',
