...
class ProviderBulkEditForm(NetPointModelBulkEditForm):
...
class ProviderAccountBulkEditForm(NetPointModelBulkEditForm):
...
class ProviderNetworkBulkEditForm(NetPointModelBulkEditForm):
    provider = DynamicModelChoiceField(
        label=_('Provider'),
        queryset=Provider.objects.all(),
        required=False
...
class CircuitTypeBulkEditForm(NetPointModelBulkEditForm):
    color = ColorField(
        label=_('Color'),
        required=False
    )
