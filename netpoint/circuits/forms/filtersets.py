...
class ProviderFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Provider
    fieldsets = (
...
class ProviderAccountFilterForm(NetPointModelFilterSetForm):
...
class ProviderNetworkFilterForm(NetPointModelFilterSetForm):
...
class CircuitTypeFilterForm(NetPointModelFilterSetForm):
    model = CircuitType
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
        (_('Attributes'), ('color',)),
...
class CircuitFilterForm(TenancyFilterForm, ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Circuit
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
