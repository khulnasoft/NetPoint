...
class ProviderTable(ContactsColumnMixin, NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ProviderAccountTable(ContactsColumnMixin, NetPointTable):
...
class ProviderNetworkTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
