...
def check_legacy_data(apps, schema_editor):
    ...
    if provider_count and 'NETPOINT_DELETE_LEGACY_DATA' not in os.environ:
        raise DataError(
            ...
            f"migrated to ASN objects before proceeding. Or, set the NETPOINT_DELETE_LEGACY_DATA "
    ...
    if provider_count and 'NETPOINT_DELETE_LEGACY_DATA' not in os.environ:
        raise DataError(
            ...
            f"migrated to contact objects before proceeding. Or, set the NETPOINT_DELETE_LEGACY_DATA "
