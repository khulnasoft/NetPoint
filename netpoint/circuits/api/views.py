...
class ProviderViewSet(NetPointModelViewSet):
...
class CircuitTypeViewSet(NetPointModelViewSet):
...
class CircuitViewSet(NetPointModelViewSet):
...
class CircuitTerminationViewSet(PassThroughPortMixin, NetPointModelViewSet):
...
class ProviderAccountViewSet(NetPointModelViewSet):
...
class ProviderNetworkViewSet(NetPointModelViewSet):
