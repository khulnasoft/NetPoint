...
from netpoint.api.fields import ChoiceField, SerializedPKRelatedField
from netpoint.api.serializers import NetPointModelSerializer, WritableNestedSerializer
...
class ProviderSerializer(NetPointModelSerializer):
...
class ProviderAccountSerializer(NetPointModelSerializer):
...
class ProviderNetworkSerializer(NetPointModelSerializer):
...
class CircuitTypeSerializer(NetPointModelSerializer):
...
class CircuitSerializer(NetPointModelSerializer):
...
class CircuitTerminationSerializer(NetPointModelSerializer, CabledObjectSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='circuits-api:circuittermination-detail')
