...
class ProviderFilterSet(NetPointModelFilterSet, ContactModelFilterSet):
...
class ProviderAccountFilterSet(NetPointModelFilterSet):
...
class ProviderNetworkFilterSet(NetPointModelFilterSet):
    provider_id = django_filters.ModelMultipleChoiceFilter(
        queryset=Provider.objects.all(),
        label=_('Provider (ID)'),
    )
...
class CircuitFilterSet(NetPointModelFilterSet, TenancyFilterSet, ContactModelFilterSet):
    provider_id = django_filters.ModelMultipleChoiceFilter(
        queryset=Provider.objects.all(),
        label=_('Provider (ID)'),
    )
...
class CircuitTerminationFilterSet(NetPointModelFilterSet, CabledObjectFilterSet):
