...
from netpoint.tests.dummy_plugin import config as dummy_config
from netpoint.tests.dummy_plugin.data_backends import DummyBackend
from netpoint.plugins.navigation import PluginMenu
from netpoint.plugins.utils import get_plugin_config
from netpoint.graphql.schema import Query
from netpoint.registry import registry


@skipIf('netpoint.tests.dummy_plugin' not in settings.PLUGINS, "dummy_plugin not in settings.PLUGINS")
class PluginTest(TestCase):

    def test_config(self):

        self.assertIn('netpoint.tests.dummy_plugin.DummyPluginConfig', settings.INSTALLED_APPS)
    ...
    def test_template_extensions(self):
        ...
        """
        from netpoint.tests.dummy_plugin.template_content import SiteContent
    ...
    def test_middleware(self):
        ...
        """
        self.assertIn('netpoint.tests.dummy_plugin.middleware.DummyMiddleware', settings.MIDDLEWARE)
    ...
    def test_queues(self):
        ...
        """
        self.assertIn('netpoint.tests.dummy_plugin.testing-low', settings.RQ_QUEUES)
        self.assertIn('netpoint.tests.dummy_plugin.testing-medium', settings.RQ_QUEUES)
        self.assertIn('netpoint.tests.dummy_plugin.testing-high', settings.RQ_QUEUES)

    def test_min_version(self):
        """
        Check enforcement of minimum NetPoint version.
        """
    ...
    def test_max_version(self):
        """
        Check enforcement of maximum NetPoint version.
        """
        with self.assertRaises(ImproperlyConfigured):
