...
class BaseObjectType(DjangoObjectType):
    """
    Base GraphQL object type for all NetPoint objects. Restricts the model queryset to enforce object permissions.
    """
...
class NetPointObjectType(
    ...
    """
    GraphQL type for most NetPoint models. Includes support for custom fields, change logging, journaling, and tags.
    """
    class Meta:
        abstract = True
