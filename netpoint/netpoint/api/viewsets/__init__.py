...
class NetPointReadOnlyModelViewSet(
...
class NetPointModelViewSet(
    ...
    def dispatch(self, request, *args, **kwargs):
        logger = logging.getLogger(f'netpoint.api.views.{self.__class__.__name__}')
