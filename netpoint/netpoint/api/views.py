...
from netpoint.plugins.utils import get_installed_plugins
from netpoint.api.authentication import IsAuthenticatedOrLoginNotRequired


class APIRootView(APIView):
    """
    This is the root of NetPoint's REST API. API endpoints are arranged by app and model name; e.g. `/api/dcim/sites/`.
    """
...
class StatusView(APIView):
    """
    A lightweight read-only endpoint for conveying NetPoint's current operational status.
    """
    ...
    def get(self, request):
        ...
        return Response({
            ...
            'netpoint-version': settings.VERSION,
