...
class NetPointModelFilterSet(ChangeLoggedModelFilterSet):
    """
    Provides additional filtering functionality (e.g. tags, custom fields) for core NetPoint models.
    """
...
class OrganizationalModelFilterSet(NetPointModelFilterSet):
    """
