    ...
    groups=(
        MenuGroup(
            ...
            items=(
                ...
                MenuItem(
                    link=f'users:netpointuser_list',
                    link_text=_('Users'),
                    permissions=[f'auth.view_user'],
                    staff_only=True,
                    buttons=(
                        MenuItemButton(
                            link=f'users:netpointuser_add',
                            title='Add',
                        ...
                        MenuItemButton(
                            link=f'users:netpointuser_import',
                            title='Import',
                ...
                MenuItem(
                    link=f'users:netpointgroup_list',
                    link_text=_('Groups'),
                    permissions=[f'auth.view_group'],
                    staff_only=True,
                    buttons=(
                        MenuItemButton(
                            link=f'users:netpointgroup_add',
                            title='Add',
                            icon_class='mdi mdi-plus-thick',
                        ...
                        MenuItemButton(
                            link=f'users:netpointgroup_import',
                            title='Import',
                            icon_class='mdi mdi-upload',
                            permissions=[f'auth.add_group'],
                            color=ButtonColorChoices.CYAN
