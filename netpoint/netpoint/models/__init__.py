...
class ChangeLoggedModel(ChangeLoggingMixin, CustomValidationMixin, EventRulesMixin, models.Model):
    ...
    support NetPoint's full feature set.
    """
...
class NetPointModel(NetPointFeatureSet, models.Model):
    """
...
#
# NetPoint internal base models
#

class PrimaryModel(NetPointModel):
    """
...
class NestedGroupModel(NetPointFeatureSet, MPTTModel):
    """
...
class OrganizationalModel(NetPointFeatureSet, models.Model):
    """
