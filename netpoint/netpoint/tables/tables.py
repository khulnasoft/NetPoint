...
from netpoint.tables import columns
...
class BaseTable(tables.Table):
    """
    Base table class for NetPoint objects. Adds support for:
...
class NetPointTable(BaseTable):
    """
    Table class for most NetPoint objects. Adds support for custom field & custom link columns. Includes
    default columns for:
