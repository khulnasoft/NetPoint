...
from netpoint.api.views import APIRootView, StatusView
from netpoint.graphql.schema import schema
from netpoint.graphql.views import GraphQLView
from netpoint.plugins.urls import plugin_admin_patterns, plugin_patterns, plugin_api_patterns
from netpoint.views import HomeView, StaticMediaFailureView, SearchView, htmx
...
handler404 = 'netpoint.views.errors.handler_404'
handler500 = 'netpoint.views.errors.handler_500'
