...
from netpoint.constants import DEFAULT_ACTION_PERMISSIONS
...
class ActionsMixin:
    ...
    def get_permitted_actions(self, user, model=None):
        ...
        if hasattr(self, 'action_perms'):
            ...
            warnings.warn(
                "Setting action_perms on views is deprecated and will be removed in NetPoint v4.0. Use actions instead.",
                DeprecationWarning
            )
