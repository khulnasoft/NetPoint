...
class AggregateTable(TenancyColumnsMixin, NetPointTable):
...
class PrefixTable(TenancyColumnsMixin, NetPointTable):
...
# IP ranges
#
class IPRangeTable(TenancyColumnsMixin, NetPointTable):
...
class IPAddressTable(TenancyColumnsMixin, NetPointTable):
...
class IPAddressAssignTable(NetPointTable):
    address = tables.TemplateColumn(
...
class AssignedIPAddressesTable(NetPointTable):
    """
