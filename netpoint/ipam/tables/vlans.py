...
class VLANGroupTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class VLANTable(TenancyColumnsMixin, NetPointTable):
...
class VLANMembersTable(NetPointTable):
    """
...
class InterfaceVLANTable(NetPointTable):
    """
