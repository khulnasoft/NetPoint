...
class ASNRangeSerializer(NetPointModelSerializer):
...
class ASNSerializer(NetPointModelSerializer):
...
class VRFSerializer(NetPointModelSerializer):
...
class RouteTargetSerializer(NetPointModelSerializer):
...
class RIRSerializer(NetPointModelSerializer):
...
class AggregateSerializer(NetPointModelSerializer):
...
class FHRPGroupSerializer(NetPointModelSerializer):
...
class FHRPGroupAssignmentSerializer(NetPointModelSerializer):
...
class RoleSerializer(NetPointModelSerializer):
...
class VLANGroupSerializer(NetPointModelSerializer):
...
class VLANSerializer(NetPointModelSerializer):
...
class CreateAvailableVLANSerializer(NetPointModelSerializer):
    site = NestedSiteSerializer(required=False, allow_null=True)
    tenant = NestedTenantSerializer(required=False, allow_null=True)
    status = ChoiceField(choices=VLANStatusChoices, required=False)
    role = NestedRoleSerializer(required=False, allow_null=True)
...
class PrefixSerializer(NetPointModelSerializer):
...
class IPRangeSerializer(NetPointModelSerializer):
...
class IPAddressSerializer(NetPointModelSerializer):
...
class ServiceTemplateSerializer(NetPointModelSerializer):
...
class ServiceSerializer(NetPointModelSerializer):
