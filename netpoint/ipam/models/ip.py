...
from netpoint.models import OrganizationalModel, PrimaryModel
...
class Aggregate(GetAvailablePrefixesMixin, PrimaryModel):
    """
    An aggregate exists at the root level of the IP address space hierarchy in NetPoint. Aggregates are used to organize
