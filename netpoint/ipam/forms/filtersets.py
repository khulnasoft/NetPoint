...
class VRFFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = VRF
    fieldsets = (
...
class RouteTargetFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = RouteTarget
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class RIRFilterForm(NetPointModelFilterSetForm):
    model = RIR
...
class AggregateFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = Aggregate
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class ASNRangeFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = ASNRange
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class ASNFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = ASN
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class RoleFilterForm(NetPointModelFilterSetForm):
    model = Role
    tag = TagFilterField(model)


class PrefixFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = Prefix
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IPRangeFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = IPRange
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class IPAddressFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = IPAddress
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class FHRPGroupFilterForm(NetPointModelFilterSetForm):
    model = FHRPGroup
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class VLANGroupFilterForm(NetPointModelFilterSetForm):
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class VLANFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = VLAN
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
        (_('Location'), ('region_id', 'site_group_id', 'site_id')),
...
class ServiceTemplateFilterForm(NetPointModelFilterSetForm):
