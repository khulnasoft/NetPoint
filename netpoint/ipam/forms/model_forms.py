...
class VRFForm(TenancyForm, NetPointModelForm):
...
class RouteTargetForm(TenancyForm, NetPointModelForm):
    fieldsets = (
...
class RIRForm(NetPointModelForm):
    slug = SlugField()
...
class AggregateForm(TenancyForm, NetPointModelForm):
...
class ASNRangeForm(TenancyForm, NetPointModelForm):
    rir = DynamicModelChoiceField(
        queryset=RIR.objects.all(),
        label=_('RIR'),
    )
...
class ASNForm(TenancyForm, NetPointModelForm):
    rir = DynamicModelChoiceField(
        queryset=RIR.objects.all(),
        label=_('RIR'),
    )
...
class RoleForm(NetPointModelForm):
    slug = SlugField()
...
class PrefixForm(TenancyForm, NetPointModelForm):
...
class IPRangeForm(TenancyForm, NetPointModelForm):
    vrf = DynamicModelChoiceField(
        queryset=VRF.objects.all(),
        required=False,
        label=_('VRF')
...
class IPAddressForm(TenancyForm, NetPointModelForm):
...
class IPAddressBulkAddForm(TenancyForm, NetPointModelForm):
    vrf = DynamicModelChoiceField(
        queryset=VRF.objects.all(),
        required=False,
        label=_('VRF')
...
class FHRPGroupForm(NetPointModelForm):
...
class VLANGroupForm(NetPointModelForm):
...
class VLANForm(TenancyForm, NetPointModelForm):
    group = DynamicModelChoiceField(
...
class ServiceTemplateForm(NetPointModelForm):
...
class ServiceForm(NetPointModelForm):
