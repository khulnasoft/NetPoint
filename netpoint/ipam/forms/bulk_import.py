...
class VRFImportForm(NetPointModelImportForm):
...
class RouteTargetImportForm(NetPointModelImportForm):
    tenant = CSVModelChoiceField(
        label=_('Tenant'),
        queryset=Tenant.objects.all(),
        required=False,
...
class RIRImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class AggregateImportForm(NetPointModelImportForm):
...
class ASNRangeImportForm(NetPointModelImportForm):
    rir = CSVModelChoiceField(
        label=_('RIR'),
        queryset=RIR.objects.all(),
        to_field_name='name',
...
class ASNImportForm(NetPointModelImportForm):
    rir = CSVModelChoiceField(
        label=_('RIR'),
        queryset=RIR.objects.all(),
        to_field_name='name',
...
class RoleImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class PrefixImportForm(NetPointModelImportForm):
...
class IPRangeImportForm(NetPointModelImportForm):
    vrf = CSVModelChoiceField(
        label=_('VRF'),
        queryset=VRF.objects.all(),
        to_field_name='name',
...
class IPAddressImportForm(NetPointModelImportForm):
    vrf = CSVModelChoiceField(
        label=_('VRF'),
        queryset=VRF.objects.all(),
        to_field_name='name',
...
class FHRPGroupImportForm(NetPointModelImportForm):
...
class VLANGroupImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class VLANImportForm(NetPointModelImportForm):
    site = CSVModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        required=False,
...
class ServiceTemplateImportForm(NetPointModelImportForm):
    protocol = CSVChoiceField(
        label=_('Protocol'),
...
class ServiceImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        required=False,
