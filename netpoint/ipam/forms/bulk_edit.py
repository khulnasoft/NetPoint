...
class VRFBulkEditForm(NetPointModelBulkEditForm):
...
class RouteTargetBulkEditForm(NetPointModelBulkEditForm):
    tenant = DynamicModelChoiceField(
        label=_('Tenant'),
        queryset=Tenant.objects.all(),
        required=False
...
class RIRBulkEditForm(NetPointModelBulkEditForm):
...
class ASNRangeBulkEditForm(NetPointModelBulkEditForm):
...
class ASNBulkEditForm(NetPointModelBulkEditForm):
...
class AggregateBulkEditForm(NetPointModelBulkEditForm):
    rir = DynamicModelChoiceField(
        queryset=RIR.objects.all(),
        required=False,
        label=_('RIR')
...
class RoleBulkEditForm(NetPointModelBulkEditForm):
...
class PrefixBulkEditForm(NetPointModelBulkEditForm):
...
class IPRangeBulkEditForm(NetPointModelBulkEditForm):
    vrf = DynamicModelChoiceField(
        queryset=VRF.objects.all(),
        required=False,
        label=_('VRF')
...
class IPAddressBulkEditForm(NetPointModelBulkEditForm):
    vrf = DynamicModelChoiceField(
        queryset=VRF.objects.all(),
        required=False,
        label=_('VRF')
...
class FHRPGroupBulkEditForm(NetPointModelBulkEditForm):
...
class VLANGroupBulkEditForm(NetPointModelBulkEditForm):
...
class VLANBulkEditForm(NetPointModelBulkEditForm):
    region = DynamicModelChoiceField(
        label=_('Region'),
        queryset=Region.objects.all(),
        required=False
...
class ServiceTemplateBulkEditForm(NetPointModelBulkEditForm):
    protocol = forms.ChoiceField(
        label=_('Protocol'),
