...
from netpoint.api.features import SyncedDataMixin
from netpoint.api.metadata import ContentTypeMetadata
from netpoint.api.renderers import TextRenderer
...
class EventRuleViewSet(NetPointModelViewSet):
...
class WebhookViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class CustomFieldViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class CustomFieldChoiceSetViewSet(NetPointModelViewSet):
...
class CustomLinkViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class ExportTemplateViewSet(SyncedDataMixin, NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class SavedFilterViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class BookmarkViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class TagViewSet(NetPointModelViewSet):
...
class ImageAttachmentViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class JournalEntryViewSet(NetPointModelViewSet):
    metadata_class = ContentTypeMetadata
...
class ConfigContextViewSet(SyncedDataMixin, NetPointModelViewSet):
...
class ConfigTemplateViewSet(SyncedDataMixin, ConfigTemplateRenderMixin, NetPointModelViewSet):
...
class ContentTypeViewSet(ReadOnlyModelViewSet):
    """
    Read-only list of ContentTypes. Limit results to ContentTypes pertinent to NetPoint objects.
    """
    permission_classes = [IsAuthenticatedOrLoginNotRequired]
