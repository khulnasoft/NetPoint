...
from netpoint.api.exceptions import SerializerNotFound
from netpoint.api.fields import ChoiceField, ContentTypeField, SerializedPKRelatedField
from netpoint.api.serializers import BaseModelSerializer, NetPointModelSerializer, ValidatedModelSerializer
from netpoint.api.serializers.features import TaggableModelSerializer
...
class EventRuleSerializer(NetPointModelSerializer):
...
class WebhookSerializer(NetPointModelSerializer):
...
class JournalEntrySerializer(NetPointModelSerializer):
