...
from netpoint.models.features import CloningMixin, ExportTemplatesMixin, SyncedDataMixin, TagsMixin
...
class ConfigTemplate(SyncedDataMixin, ExportTemplatesMixin, TagsMixin, ChangeLoggedModel):
    ...
    def render(self, context=None):
        ...
        # Populate the default template context with NetPoint model classes, namespaced by app
