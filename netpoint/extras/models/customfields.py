...
from netpoint.models.features import CloningMixin, ExportTemplatesMixin
from netpoint.search import FieldTypes
...
class CustomField(CloningMixin, ExportTemplatesMixin, ChangeLoggedModel):
    ...
    object_type = models.ForeignKey(
        ...
        blank=True,
        null=True,
        help_text=_('The type of NetPoint object this field maps to (for object fields)')
    )
