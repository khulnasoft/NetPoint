...
from netpoint.filtersets import BaseFilterSet, ChangeLoggedModelFilterSet, NetPointModelFilterSet
...
class WebhookFilterSet(NetPointModelFilterSet):
...
class EventRuleFilterSet(NetPointModelFilterSet):
    q = django_filters.CharFilter(
        method='search',
        label=_('Search'),
    )
...
class JournalEntryFilterSet(NetPointModelFilterSet):
