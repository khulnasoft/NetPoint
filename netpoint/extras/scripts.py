...
class ObjectVar(ScriptVariable):
    """
    A single object within NetPoint.

    :param model: The NetPoint model being referenced
...
class BaseScript:
    ...
    def __init__(self):
        ...
        # Initiate the log
        self.logger = logging.getLogger(f"netpoint.scripts.{self.__module__}.{self.__class__.__name__}")
        self.log = []
...
def run_script(data, job, request=None, commit=True, **kwargs):
    ...
    logger = logging.getLogger(f"netpoint.scripts.{script.full_name}")
