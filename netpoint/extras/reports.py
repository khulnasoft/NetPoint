...
class Report(object):
    """
    NetPoint users can extend this object to write custom reports to be used for validating data within NetPoint. Each
    ...
    def __init__(self):
        ...
        self.logger = logging.getLogger(f"netpoint.reports.{self.__module__}.{self.__class__.__name__}")
