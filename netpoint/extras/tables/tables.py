...
class CustomFieldTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class CustomFieldChoiceSetTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class CustomLinkTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ExportTemplateTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ImageAttachmentTable(NetPointTable):
    id = tables.Column(
        verbose_name=_('ID'),
        linkify=False
    )
...
class SavedFilterTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class BookmarkTable(NetPointTable):
...
class WebhookTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class EventRuleTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class TaggedItemTable(NetPointTable):
    id = tables.Column(
        verbose_name=_('ID'),
...
class ConfigContextTable(NetPointTable):
    data_source = tables.Column(
        verbose_name=_('Data Source'),
        linkify=True
    )
...
class ConfigTemplateTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class ObjectChangeTable(NetPointTable):
...
class JournalEntryTable(NetPointTable):
