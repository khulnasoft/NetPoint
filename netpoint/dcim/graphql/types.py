...
class CableType(NetPointObjectType):
...
class CableTerminationType(NetPointObjectType):
...
class DeviceType(ConfigContextMixin, ImageAttachmentsMixin, ContactsMixin, NetPointObjectType):
...
class DeviceTypeType(NetPointObjectType):
...
class ModuleTypeType(NetPointObjectType):
...
class PowerFeedType(NetPointObjectType, CabledObjectMixin, PathEndpointMixin):
...
class PowerPanelType(NetPointObjectType, ContactsMixin):
...
class RackType(VLANGroupsMixin, ImageAttachmentsMixin, ContactsMixin, NetPointObjectType):
...
class RackReservationType(NetPointObjectType):
...
class SiteType(VLANGroupsMixin, ImageAttachmentsMixin, ContactsMixin, NetPointObjectType):
...
class VirtualChassisType(NetPointObjectType):
...
class VirtualDeviceContextType(NetPointObjectType):
