...
class RackRoleTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class RackTable(TenancyColumnsMixin, ContactsColumnMixin, NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        order_by=('_name',),
        linkify=True
...
class RackReservationTable(TenancyColumnsMixin, NetPointTable):
