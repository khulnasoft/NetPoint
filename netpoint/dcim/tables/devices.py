...
class DeviceRoleTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class PlatformTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class DeviceTable(TenancyColumnsMixin, ContactsColumnMixin, NetPointTable):
...
class DeviceComponentTable(NetPointTable):
...
class CableTerminationTable(NetPointTable):
    cable = tables.Column(
...
class BaseInterfaceTable(NetPointTable):
...
class InventoryItemRoleTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class VirtualChassisTable(NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
...
class VirtualDeviceContextTable(TenancyColumnsMixin, NetPointTable):
    name = tables.Column(
        verbose_name=_('Name'),
        linkify=True
    )
