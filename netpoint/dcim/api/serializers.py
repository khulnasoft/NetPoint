...
from netpoint.api.fields import ChoiceField, ContentTypeField, SerializedPKRelatedField
from netpoint.api.serializers import (
    GenericObjectSerializer, NestedGroupModelSerializer, NetPointModelSerializer, ValidatedModelSerializer,
    WritableNestedSerializer,
)
from netpoint.config import ConfigItem
...
class SiteSerializer(NetPointModelSerializer):
...
class RackRoleSerializer(NetPointModelSerializer):
...
class RackSerializer(NetPointModelSerializer):
...
class RackReservationSerializer(NetPointModelSerializer):
...
class ManufacturerSerializer(NetPointModelSerializer):
...
class DeviceTypeSerializer(NetPointModelSerializer):
...
class ModuleTypeSerializer(NetPointModelSerializer):
...
class DeviceRoleSerializer(NetPointModelSerializer):
...
class PlatformSerializer(NetPointModelSerializer):
...
class DeviceSerializer(NetPointModelSerializer):
...
class VirtualDeviceContextSerializer(NetPointModelSerializer):
...
class ModuleSerializer(NetPointModelSerializer):
...
class ConsoleServerPortSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
...
class ConsolePortSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
...
class PowerOutletSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
...
class PowerPortSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
...
class InterfaceSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
...
class RearPortSerializer(NetPointModelSerializer, CabledObjectSerializer):
...
class FrontPortSerializer(NetPointModelSerializer, CabledObjectSerializer):
...
class ModuleBaySerializer(NetPointModelSerializer):
...
class DeviceBaySerializer(NetPointModelSerializer):
...
class InventoryItemSerializer(NetPointModelSerializer):
...
class InventoryItemRoleSerializer(NetPointModelSerializer):
...
class CableSerializer(NetPointModelSerializer):
...
class CableTerminationSerializer(NetPointModelSerializer):
...
class VirtualChassisSerializer(NetPointModelSerializer):
...
class PowerPanelSerializer(NetPointModelSerializer):
...
class PowerFeedSerializer(NetPointModelSerializer, CabledObjectSerializer, ConnectedEndpointsSerializer):
