...
class RegionImportForm(NetPointModelImportForm):
...
class SiteGroupImportForm(NetPointModelImportForm):
    parent = CSVModelChoiceField(
        label=_('Parent'),
...
class SiteImportForm(NetPointModelImportForm):
...
class LocationImportForm(NetPointModelImportForm):
...
class RackRoleImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class RackImportForm(NetPointModelImportForm):
    site = CSVModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        to_field_name='name'
...
class RackReservationImportForm(NetPointModelImportForm):
    site = CSVModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        to_field_name='name',
...
class ManufacturerImportForm(NetPointModelImportForm):
...
class DeviceTypeImportForm(NetPointModelImportForm):
...
class ModuleTypeImportForm(NetPointModelImportForm):
    manufacturer = forms.ModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        to_field_name='name'
...
class DeviceRoleImportForm(NetPointModelImportForm):
...
class PlatformImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class BaseDeviceImportForm(NetPointModelImportForm):
    role = CSVModelChoiceField(
        label=_('Device role'),
...
class ModuleImportForm(ModuleCommonForm, NetPointModelImportForm):
...
class ConsolePortImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class ConsoleServerPortImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class PowerPortImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class PowerOutletImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class InterfaceImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class FrontPortImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class RearPortImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class ModuleBayImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class DeviceBayImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class InventoryItemImportForm(NetPointModelImportForm):
    device = CSVModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        to_field_name='name'
...
class InventoryItemRoleImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class CableImportForm(NetPointModelImportForm):
    # Termination A
...
class VirtualChassisImportForm(NetPointModelImportForm):
...
class PowerPanelImportForm(NetPointModelImportForm):
    site = CSVModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        to_field_name='name',
...
class PowerFeedImportForm(NetPointModelImportForm):
    site = CSVModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        to_field_name='name',
...
class VirtualDeviceContextImportForm(NetPointModelImportForm):
