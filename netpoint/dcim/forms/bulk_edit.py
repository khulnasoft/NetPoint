...
class RegionBulkEditForm(NetPointModelBulkEditForm):
...
class SiteGroupBulkEditForm(NetPointModelBulkEditForm):
    parent = DynamicModelChoiceField(
        label=_('Parent'),
...
class SiteBulkEditForm(NetPointModelBulkEditForm):
...
class LocationBulkEditForm(NetPointModelBulkEditForm):
...
class RackRoleBulkEditForm(NetPointModelBulkEditForm):
    color = ColorField(
        label=_('Color'),
        required=False
    )
...
class RackBulkEditForm(NetPointModelBulkEditForm):
    region = DynamicModelChoiceField(
        label=_('Region'),
        queryset=Region.objects.all(),
        required=False,
...
class RackReservationBulkEditForm(NetPointModelBulkEditForm):
...
class ManufacturerBulkEditForm(NetPointModelBulkEditForm):
    description = forms.CharField(
        label=_('Description'),
        max_length=200,
        required=False
...
class DeviceTypeBulkEditForm(NetPointModelBulkEditForm):
...
class ModuleTypeBulkEditForm(NetPointModelBulkEditForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        required=False
...
class DeviceRoleBulkEditForm(NetPointModelBulkEditForm):
    color = ColorField(
        label=_('Color'),
        required=False
    )
...
class PlatformBulkEditForm(NetPointModelBulkEditForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        required=False
...
class DeviceBulkEditForm(NetPointModelBulkEditForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        required=False
...
class ModuleBulkEditForm(NetPointModelBulkEditForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        required=False
...
class CableBulkEditForm(NetPointModelBulkEditForm):
    type = forms.ChoiceField(
        label=_('Type'),
...
class VirtualChassisBulkEditForm(NetPointModelBulkEditForm):
...
class PowerPanelBulkEditForm(NetPointModelBulkEditForm):
    region = DynamicModelChoiceField(
        label=_('Region'),
        queryset=Region.objects.all(),
        required=False,
...
class PowerFeedBulkEditForm(NetPointModelBulkEditForm):
...
class ComponentBulkEditForm(NetPointModelBulkEditForm):
...
class InventoryItemRoleBulkEditForm(NetPointModelBulkEditForm):
    color = ColorField(
        label=_('Color'),
        required=False
    )
...
class VirtualDeviceContextBulkEditForm(NetPointModelBulkEditForm):
    device = DynamicModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        required=False
