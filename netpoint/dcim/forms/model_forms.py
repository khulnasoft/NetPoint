...
class RegionForm(NetPointModelForm):
...
class SiteGroupForm(NetPointModelForm):
    parent = DynamicModelChoiceField(
        label=_('Parent'),
...
class SiteForm(TenancyForm, NetPointModelForm):
...
class LocationForm(TenancyForm, NetPointModelForm):
...
class RackRoleForm(NetPointModelForm):
    slug = SlugField()
...
class RackForm(TenancyForm, NetPointModelForm):
    site = DynamicModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        selector=True
...
class RackReservationForm(TenancyForm, NetPointModelForm):
...
class ManufacturerForm(NetPointModelForm):
    slug = SlugField()
...
class DeviceTypeForm(NetPointModelForm):
...
class ModuleTypeForm(NetPointModelForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all()
    )
...
class DeviceRoleForm(NetPointModelForm):
...
class PlatformForm(NetPointModelForm):
    manufacturer = DynamicModelChoiceField(
        label=_('Manufacturer'),
        queryset=Manufacturer.objects.all(),
        required=False
...
class DeviceForm(TenancyForm, NetPointModelForm):
    site = DynamicModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        selector=True
...
class ModuleForm(ModuleCommonForm, NetPointModelForm):
...
class CableForm(TenancyForm, NetPointModelForm):
    comments = CommentField()
...
class PowerPanelForm(NetPointModelForm):
    site = DynamicModelChoiceField(
        label=_('Site'),
        queryset=Site.objects.all(),
        selector=True
...
class PowerFeedForm(TenancyForm, NetPointModelForm):
...
class VirtualChassisForm(NetPointModelForm):
...
class DeviceComponentForm(NetPointModelForm):
    device = DynamicModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        selector=True
...
class InventoryItemRoleForm(NetPointModelForm):
    slug = SlugField()
...
class VirtualDeviceContextForm(TenancyForm, NetPointModelForm):
    device = DynamicModelChoiceField(
        label=_('Device'),
        queryset=Device.objects.all(),
        selector=True
