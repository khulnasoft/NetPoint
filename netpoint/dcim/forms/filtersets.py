...
from netpoint.forms import NetPointModelFilterSetForm
...
class DeviceComponentFilterForm(NetPointModelFilterSetForm):
...
class RegionFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Region
    fieldsets = (
...
class SiteGroupFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = SiteGroup
    fieldsets = (
        (None, ('q', 'filter_id', 'tag', 'parent_id')),
        (_('Contacts'), ('contact', 'contact_role', 'contact_group'))
...
class SiteFilterForm(TenancyFilterForm, ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Site
    fieldsets = (
...
class LocationFilterForm(TenancyFilterForm, ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Location
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class RackRoleFilterForm(NetPointModelFilterSetForm):
    model = RackRole
    tag = TagFilterField(model)


class RackFilterForm(TenancyFilterForm, ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Rack
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class RackReservationFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
...
class ManufacturerFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = Manufacturer
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
        (_('Contacts'), ('contact', 'contact_role', 'contact_group'))
...
class DeviceTypeFilterForm(NetPointModelFilterSetForm):
    model = DeviceType
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class ModuleTypeFilterForm(NetPointModelFilterSetForm):
    model = ModuleType
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class DeviceRoleFilterForm(NetPointModelFilterSetForm):
    model = DeviceRole
...
class PlatformFilterForm(NetPointModelFilterSetForm):
    model = Platform
    selector_fields = ('filter_id', 'q', 'manufacturer_id')
    manufacturer_id = DynamicModelMultipleChoiceField(
        queryset=Manufacturer.objects.all(),
...
class ModuleFilterForm(LocalConfigContextFilterForm, TenancyFilterForm, NetPointModelFilterSetForm):
    model = Module
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class VirtualChassisFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
...
class CableFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = Cable
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class PowerPanelFilterForm(ContactModelFilterForm, NetPointModelFilterSetForm):
    model = PowerPanel
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
        (_('Location'), ('region_id', 'site_group_id', 'site_id', 'location_id')),
...
class PowerFeedFilterForm(TenancyFilterForm, NetPointModelFilterSetForm):
    model = PowerFeed
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
...
class InventoryItemRoleFilterForm(NetPointModelFilterSetForm):
