...
def check_legacy_data(apps, schema_editor):
    ...
    if site_count and 'NETPOINT_DELETE_LEGACY_DATA' not in os.environ:
        raise DataError(
            ...
            f"before proceeding. Or, set the NETPOINT_DELETE_LEGACY_DATA environment variable to bypass "
    ...
    if site_count and 'NETPOINT_DELETE_LEGACY_DATA' not in os.environ:
        raise DataError(
            ...
            f"contact objects before proceeding. Or, set the NETPOINT_DELETE_LEGACY_DATA environment "
