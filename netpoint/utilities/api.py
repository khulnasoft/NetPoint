...
from netpoint.api.exceptions import GraphQLTypeNotFound, SerializerNotFound
...
def get_serializer_for_model(model, prefix=''):
    ...
    if app_name == 'users':
        if model_name == 'NetPointUser':
            model_name = 'User'
        elif model_name == 'NetPointGroup':
            model_name = 'Group'
...
def rest_api_server_error(request, *args, **kwargs):
    ...
    data = {
        ...
        'netpoint_version': settings.VERSION,
