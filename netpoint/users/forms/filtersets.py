...
class GroupFilterForm(NetPointModelFilterSetForm):
    model = NetPointGroup
    fieldsets = (
        (None, ('q', 'filter_id',)),
    )
...
class UserFilterForm(NetPointModelFilterSetForm):
    model = NetPointUser
    fieldsets = (
        (None, ('q', 'filter_id',)),
        (_('Group'), ('group_id',)),
...
class ObjectPermissionFilterForm(NetPointModelFilterSetForm):
