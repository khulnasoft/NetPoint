...
from netpoint.models import NestedGroupModel, PrimaryModel
from netpoint.models.features import ContactsMixin
...
class Tenant(ContactsMixin, PrimaryModel):
    """
    A Tenant represents an organization served by the NetPoint owner. This is typically a customer or an internal
    department.
    """
    name = models.CharField(
        verbose_name=_('name'),
