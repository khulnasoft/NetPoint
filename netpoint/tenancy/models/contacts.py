...
from netpoint.models import ChangeLoggedModel, NestedGroupModel, OrganizationalModel, PrimaryModel
from netpoint.models.features import CustomFieldsMixin, ExportTemplatesMixin, TagsMixin
...
class Contact(PrimaryModel):
    """
    Contact information for a particular object(s) in NetPoint.
    """
