...
class ContactFilterSet(NetPointModelFilterSet):
...
class ContactAssignmentFilterSet(NetPointModelFilterSet):
...
class TenantFilterSet(NetPointModelFilterSet, ContactModelFilterSet):
    group_id = TreeNodeMultipleChoiceFilter(
        queryset=TenantGroup.objects.all(),
        field_name='group',
        lookup_expr='in',
