...
class TenantGroupImportForm(NetPointModelImportForm):
...
class TenantImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class ContactGroupImportForm(NetPointModelImportForm):
    parent = CSVModelChoiceField(
        label=_('Parent'),
...
class ContactRoleImportForm(NetPointModelImportForm):
    slug = SlugField()
...
class ContactImportForm(NetPointModelImportForm):
    group = CSVModelChoiceField(
        label=_('Group'),
        queryset=ContactGroup.objects.all(),
        required=False,
...
class ContactAssignmentImportForm(NetPointModelImportForm):
