...
from netpoint.api.fields import ChoiceField, ContentTypeField
from netpoint.api.serializers import NestedGroupModelSerializer, NetPointModelSerializer
...
class TenantSerializer(NetPointModelSerializer):
...
class ContactRoleSerializer(NetPointModelSerializer):
...
class ContactSerializer(NetPointModelSerializer):
...
class ContactAssignmentSerializer(NetPointModelSerializer):
